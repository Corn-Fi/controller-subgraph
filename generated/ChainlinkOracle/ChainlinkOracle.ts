...
export class ChainlinkOracle__getBillingResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkOracle__latestConfigDetailsResult {
  value0: BigInt;
  value1: BigInt;
  value2: Bytes;
...
export class ChainlinkOracle__latestTransmissionDetailsResult {
  value0: Bytes;
  value1: BigInt;
  value2: i32;
  value3: BigInt;
...
export class ChainlinkOracle__validatorConfigResult {
  value0: Address;
  value1: BigInt;
...
export class ChainlinkOracle extends ethereum.SmartContract {
  ...
  getBilling(): ChainlinkOracle__getBillingResult {
    let result = super.call(
      "getBilling",
    ...
    return new ChainlinkOracle__getBillingResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getBilling(): ethereum.CallResult<ChainlinkOracle__getBillingResult> {
    let result = super.tryCall(
      "getBilling",
      "getBilling():(uint32,uint32,uint32,uint32,uint32)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new ChainlinkOracle__getBillingResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestConfigDetails(): ChainlinkOracle__latestConfigDetailsResult {
    let result = super.call(
      "latestConfigDetails",
    ...
    return new ChainlinkOracle__latestConfigDetailsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBytes()
    );
  ...
  try_latestConfigDetails(): ethereum.CallResult<
    ChainlinkOracle__latestConfigDetailsResult
  > {
    let result = super.tryCall(
      "latestConfigDetails",
      "latestConfigDetails():(uint32,uint32,bytes16)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkOracle__latestConfigDetailsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBytes()
      )
  ...
  latestTransmissionDetails(): ChainlinkOracle__latestTransmissionDetailsResult {
    let result = super.call(
    ...
    return new ChainlinkOracle__latestTransmissionDetailsResult(
      result[0].toBytes(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toBigInt(),
  ...
  try_latestTransmissionDetails(): ethereum.CallResult<
    ChainlinkOracle__latestTransmissionDetailsResult
  > {
    let result = super.tryCall(
      "latestTransmissionDetails",
      "latestTransmissionDetails():(bytes16,uint32,uint8,int192,uint64)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkOracle__latestTransmissionDetailsResult(
        value[0].toBytes(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toBigInt(),
  ...
  validatorConfig(): ChainlinkOracle__validatorConfigResult {
    let result = super.call(
      "validatorConfig",
    ...
    return new ChainlinkOracle__validatorConfigResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_validatorConfig(): ethereum.CallResult<
    ChainlinkOracle__validatorConfigResult
  > {
    let result = super.tryCall(
      "validatorConfig",
      "validatorConfig():(address,uint32)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkOracle__validatorConfigResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
